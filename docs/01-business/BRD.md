...
The weekly AI advisory layer is powered by the Anthropic Claude API. 
...
- The Anthropic Claude API remains available and within
...
| **Budget**         | $5 total hard cap set in the Anthropic dashboard — all tools operate within free tiers (Supabase, Vercel, Figma, GitHub) except the Claude API, which charges per token at an estimated total cost of under $2 for v1.0's single-user usage volume. |
